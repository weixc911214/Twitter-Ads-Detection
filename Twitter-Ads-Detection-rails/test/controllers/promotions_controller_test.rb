...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { keyword: @promotion.keyword, password: @promotion.password, username: @promotion.username }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { keyword: @promotion.keyword, password: @promotion.password, username: @promotion.username }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
